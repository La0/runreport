...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Plan', fields ['slug']
        db.delete_unique('plan_plan', ['slug'])

        # Adding unique constraint on 'Plan', fields ['slug', 'creator']
        db.create_unique('plan_plan', ['slug', 'creator_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Plan', fields ['slug', 'creator']
        db.delete_unique('plan_plan', ['slug', 'creator_id'])

        # Adding unique constraint on 'Plan', fields ['slug']
        db.create_unique('plan_plan', ['slug'])
