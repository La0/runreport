...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PlanSession', fields ['week', 'day']
        db.create_unique('plan_plansession', ['week_id', 'day'])


    def backwards(self, orm):
        # Removing unique constraint on 'PlanSession', fields ['week', 'day']
        db.delete_unique('plan_plansession', ['week_id', 'day'])
