...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlanUsage'
        db.create_table('plan_planusage', (
            ...
            ('mail_sent', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal('plan', ['PlanUsage'])


    def backwards(self, orm):
        # Deleting model 'PlanUsage'
        db.delete_table('plan_planusage')
