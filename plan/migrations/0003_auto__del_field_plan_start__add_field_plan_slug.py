...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Plan.start'
        db.delete_column('plan_plan', 'start')

        # Adding field 'Plan.slug'
        db.add_column('plan_plan', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Plan.start'
        db.add_column('plan_plan', 'start',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Plan.slug'
        db.delete_column('plan_plan', 'slug')
