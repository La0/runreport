...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RunReport.time'
        db.alter_column('run_runreport', 'time', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'RunReport.time'
        db.alter_column('run_runreport', 'time', self.gf('django.db.models.fields.TimeField')(null=True))
