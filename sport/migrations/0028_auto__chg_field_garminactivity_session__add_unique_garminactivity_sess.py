...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SportSession.name'
        db.add_column('sport_session', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SportSession.comment'
        db.add_column('sport_session', 'comment',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SportSession.name'
        db.delete_column('sport_session', 'name')

        # Deleting field 'SportSession.comment'
        db.delete_column('sport_session', 'comment')
    ...
    models = {
        ...
        u'users.athlete': {
            ...
            'multi_sports': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
