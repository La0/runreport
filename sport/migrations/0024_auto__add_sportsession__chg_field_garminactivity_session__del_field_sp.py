...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SportSession'
        db.create_table('sport_session', (
        ...
        # Remove Garmin activities links to sessions
        db.alter_column('garmin_activity', 'session_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sport.SportDay'], null=True))
    ...
    def backwards(self, orm):
        # Deleting model 'SportSession'
        db.delete_table('sport_session')


        # Changing field 'GarminActivity.session'
        db.alter_column('garmin_activity', 'session_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sport.SportDay']))
        # Adding field 'SportDay.sport'
        db.add_column('sport_day', 'sport',
    ...
    models = {
        ...
        'sport.garminactivity': {
            ...
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'garmin_activities'", 'to': "orm['sport.SportSession']"}),
