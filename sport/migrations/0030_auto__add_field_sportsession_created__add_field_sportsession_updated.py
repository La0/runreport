...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SportSession.created'
        db.add_column('sport_session', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 5, 30, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'SportSession.updated'
        db.add_column('sport_session', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 5, 30, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SportSession.created'
        db.delete_column('sport_session', 'created')

        # Deleting field 'SportSession.updated'
        db.delete_column('sport_session', 'updated')
