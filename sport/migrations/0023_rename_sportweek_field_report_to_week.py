...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
      db.drop_foreign_key('sport_day', 'report_id')
      db.rename_column(u'sport_day', 'report_id', 'week_id')
      db.alter_column('sport_day', 'week_id', models.ForeignKey(to=orm['sport.SportWeek']))


    def backwards(self, orm):
      db.drop_foreign_key('sport_day', 'week_id')
      db.rename_column(u'sport_day', 'week_id', 'report_id')
      db.alter_column('sport_day', 'report_id', models.ForeignKey(to=orm['sport.SportWeek']))
    ...
    models = {
        ...
        'sport.sportday': {
            ...
            'week': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sessions'", 'to': "orm['sport.SportWeek']"})
        },
        'sport.sportweek': {
