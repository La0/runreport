...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RunSession.plan_session'
        db.add_column('run_runsession', 'plan_session',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plan.PlanSession'], null=True),
                      keep_default=False)

        # Adding field 'RunReport.plan_week'
        db.add_column('run_runreport', 'plan_week',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plan.PlanWeek'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RunSession.plan_session'
        db.delete_column('run_runsession', 'plan_session_id')

        # Deleting field 'RunReport.plan_week'
        db.delete_column('run_runreport', 'plan_week_id')
    ...
    models = {
        ...
        'run.runreport': {
            ...
            'distance': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'plan_week': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plan.PlanWeek']", 'null': 'True'}),
        ...
        'run.runsession': {
            ...
            'plan_session': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plan.PlanSession']", 'null': 'True'}),
