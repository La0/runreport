...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RunSession.day'
        db.delete_column('run_runsession', 'day')

        # Adding field 'RunSession.date'
        db.add_column('run_runsession', 'date',
                      self.gf('django.db.models.fields.DateField')(default='2013-01-01'),
                      keep_default=False)

        # Adding unique constraint on 'RunSession', fields ['report', 'date']
        db.create_unique('run_runsession', ['report_id', 'date'])


    def backwards(self, orm):
        # Removing unique constraint on 'RunSession', fields ['report', 'date']
        db.delete_unique('run_runsession', ['report_id', 'date'])

        # Adding field 'RunSession.day'
        db.add_column('run_runsession', 'day',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'RunSession.date'
        db.delete_column('run_runsession', 'date')
