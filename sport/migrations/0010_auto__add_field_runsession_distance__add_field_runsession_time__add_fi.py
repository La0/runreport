...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RunSession.distance'
        db.add_column('run_runsession', 'distance',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RunSession.time'
        db.add_column('run_runsession', 'time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RunReport.distance'
        db.add_column('run_runreport', 'distance',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RunReport.time'
        db.add_column('run_runreport', 'time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RunSession.distance'
        db.delete_column('run_runsession', 'distance')

        # Deleting field 'RunSession.time'
        db.delete_column('run_runsession', 'time')

        # Deleting field 'RunReport.distance'
        db.delete_column('run_runreport', 'distance')

        # Deleting field 'RunReport.time'
        db.delete_column('run_runreport', 'time')
