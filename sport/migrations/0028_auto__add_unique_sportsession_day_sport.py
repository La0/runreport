...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SportSession', fields ['day', 'sport']
        db.create_unique('sport_session', ['day_id', 'sport_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SportSession', fields ['day', 'sport']
        db.delete_unique('sport_session', ['day_id', 'sport_id'])
    ...
    models = {
        ...
        'sport.sportsession': {
            'Meta': {'unique_together': "(('day', 'sport'),)", 'object_name': 'SportSession', 'db_table': "'sport_session'"},
