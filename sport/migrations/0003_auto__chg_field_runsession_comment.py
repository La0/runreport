...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RunSession.comment'
        db.alter_column('run_runsession', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RunSession.comment'
        raise RuntimeError("Cannot reverse this migration. 'RunSession.comment' and its values cannot be restored.")
