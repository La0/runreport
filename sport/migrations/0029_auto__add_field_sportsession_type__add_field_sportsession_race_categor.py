...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SportSession.type'
        db.add_column('sport_session', 'type',
                      self.gf('django.db.models.fields.CharField')(default='training', max_length=12),
                      keep_default=False)

        # Adding field 'SportSession.race_category'
        db.add_column('sport_session', 'race_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sport.RaceCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SportSession.type'
        db.delete_column('sport_session', 'type')

        # Deleting field 'SportSession.race_category'
        db.delete_column('sport_session', 'race_category_id')
