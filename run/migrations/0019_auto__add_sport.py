...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sport'
        db.create_table(u'run_sport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['run.Sport'], null=True)),
            ('depth', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'run', ['Sport'])


    def backwards(self, orm):
        # Deleting model 'Sport'
        db.delete_table(u'run_sport')
