...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RunSession.garmin_activity'
        db.delete_column(u'run_runsession', 'garmin_activity_id')

        # Adding field 'GarminActivity.session'
        db.add_column(u'run_garminactivity', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='garmin_activities', to=orm['run.RunSession']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RunSession.garmin_activity'
        db.add_column(u'run_runsession', 'garmin_activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['run.GarminActivity'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'GarminActivity.session'
        db.delete_column(u'run_garminactivity', 'session_id')
