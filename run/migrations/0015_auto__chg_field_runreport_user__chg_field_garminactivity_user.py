...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RunReport.user'
        db.alter_column(u'run_runreport', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Athlete']))

        # Changing field 'GarminActivity.user'
        db.alter_column(u'run_garminactivity', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Athlete']))

    def backwards(self, orm):

        # Changing field 'RunReport.user'
        db.alter_column(u'run_runreport', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'GarminActivity.user'
        db.alter_column(u'run_garminactivity', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
