...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('run_garminactivity', (
        ...
        db.send_create_signal('run', ['GarminActivity'])

        # Adding field 'RunSession.garmin_activity'
        db.add_column('run_runsession', 'garmin_activity',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('run_garminactivity')

        # Deleting field 'RunSession.garmin_activity'
        db.delete_column('run_runsession', 'garmin_activity_id')
