...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'GarminActivity.sport' to match new field type.
        db.rename_column(u'run_garminactivity', 'sport', 'sport_id')
        # Changing field 'GarminActivity.sport'
        db.alter_column(u'run_garminactivity', 'sport_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['run.Sport']))
        # Adding index on 'GarminActivity', fields ['sport']
        db.create_index(u'run_garminactivity', ['sport_id'])


    def backwards(self, orm):
        # Removing index on 'GarminActivity', fields ['sport']
        db.delete_index(u'run_garminactivity', ['sport_id'])


        # Renaming column for 'GarminActivity.sport' to match new field type.
        db.rename_column(u'run_garminactivity', 'sport_id', 'sport')
        # Changing field 'GarminActivity.sport'
        db.alter_column(u'run_garminactivity', 'sport', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'run.garminactivity': {
            ...
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'garmin_activities'", 'to': u"orm['run.RunSession']"}),
            'speed': ('django.db.models.fields.TimeField', [], {}),
            'sport': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['run.Sport']"}),
        ...
        u'run.sport': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['run.Sport']", 'null': 'True'}),
