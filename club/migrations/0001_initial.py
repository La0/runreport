...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ClubMembership'
        db.create_table('club_clubmembership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('club', ['ClubMembership'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ClubMembership'
        db.delete_table('club_clubmembership')
    ...
    models = {
        ...
        'club.clubmembership': {
            'Meta': {'object_name': 'ClubMembership'},
