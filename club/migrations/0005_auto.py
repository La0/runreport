...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field trainers on 'ClubMembership'
        db.create_table('club_clubmembership_trainers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('clubmembership', models.ForeignKey(orm['club.clubmembership'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('club_clubmembership_trainers', ['clubmembership_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field trainers on 'ClubMembership'
        db.delete_table('club_clubmembership_trainers')
    ...
    models = {
        ...
        'club.clubmembership': {
            ...
            'trainers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'trainer'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
