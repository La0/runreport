...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Club.main_trainer'
        db.add_column('club_club', 'main_trainer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='club_main_trainer', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Club.main_trainer'
        db.delete_column('club_club', 'main_trainer_id')
