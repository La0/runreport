...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Club.manager'
        db.add_column('club_club', 'manager',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='club_manager', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Club.address'
        db.add_column('club_club', 'address',
                      self.gf('django.db.models.fields.CharField')(default='Max rousi\xc3\xa9', max_length=250),
                      keep_default=False)

        # Adding field 'Club.zipcode'
        db.add_column('club_club', 'zipcode',
                      self.gf('django.db.models.fields.CharField')(default='75017', max_length=10),
                      keep_default=False)

        # Adding field 'Club.city'
        db.add_column('club_club', 'city',
                      self.gf('django.db.models.fields.CharField')(default='Paris', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Club.manager'
        db.delete_column('club_club', 'manager_id')

        # Deleting field 'Club.address'
        db.delete_column('club_club', 'address')

        # Deleting field 'Club.zipcode'
        db.delete_column('club_club', 'zipcode')

        # Deleting field 'Club.city'
        db.delete_column('club_club', 'city')
