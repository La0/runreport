...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('club_clubinvite', (
            ...
            ('club', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['club.Club'], null=True, blank=True)),
    ...
    models = {
        ...
        'club.clubinvite': {
            ...
            'club': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['club.Club']", 'null': 'True', 'blank': 'True'}),
