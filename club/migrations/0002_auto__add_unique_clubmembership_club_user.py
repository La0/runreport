...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ClubMembership', fields ['club', 'user']
        db.create_unique('club_clubmembership', ['club_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ClubMembership', fields ['club', 'user']
        db.delete_unique('club_clubmembership', ['club_id', 'user_id'])
