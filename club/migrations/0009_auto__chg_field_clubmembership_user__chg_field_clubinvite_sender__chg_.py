...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClubMembership.user'
        db.alter_column(u'club_clubmembership', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Athlete']))

        # Changing field 'ClubInvite.sender'
        db.alter_column(u'club_clubinvite', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Athlete']))
        ...
        # Changing field 'Club.main_trainer'
        db.alter_column(u'club_club', 'main_trainer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.Athlete']))

        # Changing field 'Club.manager'
        db.alter_column(u'club_club', 'manager_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Athlete']))

    def backwards(self, orm):

        # Changing field 'ClubMembership.user'
        db.alter_column(u'club_clubmembership', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'ClubInvite.sender'
        db.alter_column(u'club_clubinvite', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'ClubInvite.recipient'
        db.alter_column(u'club_clubinvite', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Club.main_trainer'
        db.alter_column(u'club_club', 'main_trainer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Club.manager'
        db.alter_column(u'club_club', 'manager_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
