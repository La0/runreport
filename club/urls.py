...
club_patterns = patterns('',
  ...
  url(r'^/no-trainer/?$', ClubMembers.as_view(), {'type' : 'notrainer', }, name="club-no-trainer", ),
  ...
  # Subscriptions
  url(r'^/subscriptions/add/?$', ClubSubscriptionsAdd.as_view(), name="club-subscriptions-add"),
