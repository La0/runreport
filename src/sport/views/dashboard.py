...
class DashBoardView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        self.mode = self.kwargs.get(
            'type', self.is_trainer and 'trainer' or 'athlete')
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        # Load trainer data
        if self.mode == 'trainer':
            context['memberships'] = self.request.user.memberships.filter(
                role='trainer')
    ...
    def load_friends_sessions(self):
        ...
        * grouped by athletes
        ...
        sessions = sessions.order_by(
            'day__week__user__first_name', 'day__date')
