...
class Plan(models.Model):
    ...
    def update_weeks(self):
        ...
        '''
        weeks = self.sessions.order_by('week').values_list(
        ...
        for u in users.all():
            ...
            for s in self.sessions.all():
                try:
                    ...
                    logger.warning(
                        'Failed to apply plan session #%d : %s' %
                        (s.pk, e))
...
class PlanSession(models.Model):
    ...
    def delete(self, *args, **kwargs):
        ...
        out = super(
            ...
            self).delete(
            *args,
            **kwargs)  # actually delete the session
    ...
    def apply(self, application):
        ...
        def __create():
            ...
            # Apply plan session
            psa, created = PlanSessionApplied.objects.get_or_create(
                plan_session=self, application=application, defaults={
