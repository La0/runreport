...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.garmin_login'
        db.add_column('users_userprofile', 'garmin_login',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.garmin_password'
        db.add_column('users_userprofile', 'garmin_password',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.garmin_login'
        db.delete_column('users_userprofile', 'garmin_login')

        # Deleting field 'UserProfile.garmin_password'
        db.delete_column('users_userprofile', 'garmin_password')
