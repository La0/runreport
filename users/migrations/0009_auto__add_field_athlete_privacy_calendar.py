...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Athlete.privacy_calendar'
        db.add_column(u'users_athlete', 'privacy_calendar',
                      self.gf('django.db.models.fields.CharField')(default='private', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Athlete.privacy_calendar'
        db.delete_column(u'users_athlete', 'privacy_calendar')
