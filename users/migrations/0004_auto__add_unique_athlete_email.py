...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Athlete', fields ['email']
        db.create_unique(u'users_athlete', ['email'])


    def backwards(self, orm):
        # Removing unique constraint on 'Athlete', fields ['email']
        db.delete_unique(u'users_athlete', ['email'])
