...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_userprofile', (
            ...
            ('trainer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trainee', null=True, to=orm['auth.User'])),
            ('reminder_monday', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('reminder_tuesday', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('reminder_wednesday', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('reminder_thursday', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('reminder_friday', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('reminder_saturday', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('reminder_sunday', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
        ))
