...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.trainer'
        db.delete_column('users_userprofile', 'trainer_id')


    def backwards(self, orm):
        # Adding field 'UserProfile.trainer'
        db.add_column('users_userprofile', 'trainer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='trainee', null=True, to=orm['auth.User']),
                      keep_default=False)
