...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Athlete.multi_sports'
        db.add_column(u'users_athlete', 'multi_sports',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Athlete.multi_sports'
        db.delete_column(u'users_athlete', 'multi_sports')
