...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.frequency_rest'
        db.add_column('users_userprofile', 'frequency_rest',
    ...
    def backwards(self, orm):
        # Deleting field 'UserProfile.frequency_rest'
        db.delete_column('users_userprofile', 'frequency_rest')
