...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.nb_sessions'
        db.add_column('users_userprofile', 'nb_sessions',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.license'
        db.add_column('users_userprofile', 'license',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.nb_sessions'
        db.delete_column('users_userprofile', 'nb_sessions')

        # Deleting field 'UserProfile.license'
        db.delete_column('users_userprofile', 'license')
