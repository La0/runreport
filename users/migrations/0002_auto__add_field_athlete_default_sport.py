...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Athlete.default_sport'
        db.add_column(u'users_athlete', 'default_sport',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['sport.Sport']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Athlete.default_sport'
        db.delete_column(u'users_athlete', 'default_sport_id')
