...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.auto_send'
        db.add_column('users_userprofile', 'auto_send',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.auto_send'
        db.delete_column('users_userprofile', 'auto_send')
